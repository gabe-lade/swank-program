...
blocks:
  ...
  - type: heading
    id: "more-maps"
    text: "More maps coming soon"
  - type: para
    text: "This page will grow with the newsletter series. Coming next: where each tax is <em>collected</em> across Ohio's 88 counties, and what local governments <em>spend</em> the money on."
use_cite:
