...
<article class="page">
  <header class="page-header">
    <h1>Data Insights</h1>
    <p class="page-subtitle">Short explainers with maps and charts on rural-urban policy issues.</p>
  </header>

  <div class="page-content">
    <p class="section-intro">
      Data Insights will feature one-page explainers that combine background context, maps, charts, and source notes for key policy topics.
    </p>
